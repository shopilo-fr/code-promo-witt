#!/usr/bin/env python3
"""
Recuperation des codes promo Witt depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/witt.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/witt.fr"
STORE_NAME = "Witt"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Witt depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-witt)"
    }
    try:
